...
/// SM4 字符串加密。返回值：加密后的字符串，base64编码字符
+ (nullable NSString *)ecbDefaultEncryptText:(NSString *)plaintext key:(NSString *)key;
...
/// SM4 字符串解密。base64字符串 返回值：解密后的明文
+ (nullable NSString *)ecbDefaultDecryptText:(NSString *)ciphertext key:(NSString *)key;
